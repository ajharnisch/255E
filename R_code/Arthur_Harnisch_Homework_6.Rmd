---
title: 'Arthur Harnisch Homework #6'
...
Examples of how to create data requests are given on the NOAA ERDDAP website: https://opendap.co-ops.nos.noaa.gov/erddap/index.html

First we will request data for Monterey CA (station 9413450) for the month of January 2017.
...
```{r}
plot(x= res$TimeTC, y=res$TideXT, type = '1') #1 would be line graph B would be Box plot. 
```

...
#library(reshape)
#Exp7 = cast(Exp, ramp.num~Trial, value = "average.of.all.interval.points")
...
ggplot(Control, aes(x=ramp.num, y=pvb.min, color = Trial))+
  ...
  scale_y_continuous("Percent varation from baseline")
...
a1 = ggplot(Exp, aes(x= ramp.num, y= pvb.BL.tension, color = Trial)) +geom_line()+ ggtitle("Baseline Tension")+theme(plot.title = element_text(hjust=0.5)) +scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")+theme(legend.position = "none")


#plot of peak tension

b1 =ggplot(Exp, aes(x = ramp.num, y=pvb.peak.tension, color = Trial)) +geom_line()+ggtitle("Peak Tension")+
theme(plot.title = element_text(hjust=0.5))+scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")+theme(legend.position = "none")
...
a_2 = ggplot(Control, aes(x= ramp.num, y= pvb.BL.tension, color = Trial)) +geom_line() +ggtitle("Control Baseline Tension")+
  theme(plot.title = element_text(hjust=0.5))+theme(legend.position = "none")+
scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")+theme(legend.position = "none")


#plot of peak tension

b_2 = ggplot(Control, aes(x = ramp.num, y=pvb.peak.tension, color = Trial)) +geom_line()+ggtitle("Control Peak Tension")+
  theme(plot.title = element_text(hjust=0.5))+
  scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")+theme(legend.position = "none")
...
c_2 = ggplot(Control, aes(x=ramp.num, y=pvb.SR, color= Trial))+geom_line() +ggtitle("Control SR")+
  theme(plot.title = element_text(hjust=0.5))+
  scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")+theme(legend.position = "none")
#plot of min tension

d_2 = ggplot(Control, aes(x=ramp.num, y=pvb.min, color = Trial))+geom_line() +ggtitle("Control Minimum")+
  theme(plot.title = element_text(hjust=0.5))+scale_x_continuous("Time(Min.)")+scale_x_continuous("Time(Min.)")+scale_y_continuous("Percent varation from baseline")
...
a_1 = ggplot(Exp, aes(x= ramp.num, y= pvb.BL.tension, color = Trial)) +geom_line()+ ggtitle("Baseline Tension")+theme(plot.title = element_text(hjust=0.5)) +theme(legend.position = "none")+labs(x = NULL, y=NULL)


#plot of peak tension

b_1 =ggplot(Exp, aes(x = ramp.num, y=pvb.peak.tension, color = Trial)) +geom_line()+ggtitle("Peak Tension")+
theme(plot.title = element_text(hjust=0.5))+theme(legend.position = "none")+labs(x = NULL, y=NULL)


#plot of peak plateu 3.25-3.75

c_1 =ggplot(Exp, aes(x=ramp.num, y=pvb.SR, color= Trial))+geom_line() +ggtitle("SR") +
  theme(plot.title = element_text(hjust=0.5))+theme(legend.position = "none")+labs(x = NULL, y=NULL)


#plot of min tension

d_3 =ggplot(Exp, aes(x=ramp.num, y=pvb.min, color = Trial))+geom_line() +ggtitle("Minimum")+
  theme(plot.title = element_text(hjust=0.5))+scale_x_continuous("Time(Min.)")+theme(legend.position = "none")+labs(y=NULL)



a2 = ggplot(Control, aes(x= ramp.num, y= pvb.BL.tension, color = Trial)) +geom_line() +ggtitle("Control Baseline Tension")+
  theme(plot.title = element_text(hjust=0.5))+theme(legend.position = "none")+labs(x = NULL, y=NULL)
...
multiplot(a2, b2, c2, d2,a_1,b_1, c_1,d_3, cols =2)
...
Produces a plot of averages compared to time of experiment for multiple trials for average tension 3.25-3.75 of 4 sec. static stretch with error bars. A plot will be generated for treatment, control, and for treatment and control.  
...
ggplot(graph1, aes(x=Macro, y=avg.all.macro, colour= type)) + 
   geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1) +
    geom_line() +
    geom_point()+
...
Produces two dot plots with error bars that will compare the percent variation from baseline for both the treatment and control groups for baseline tension.  
...
# plot of experiment group


Exp_12 = Exp_11%>%
  group_by(type)%>%
 summarise(ymin = mean(Exp_11$ymin), ymax = mean(Exp_11$ymax), avg = mean(Exp_11$avg))

 p <- ggplot(Exp_12, aes(x=type, y= avg)) + geom_boxplot()+geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1)+geom_point(aes(x=type, y=avg))
 
 
 ggplot(Exp_11, aes(x=type, y=avg))+geom_bar()
 
 

p = ggplot(Exp_12, aes(x=type, y=avg))+ geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1)
 
ggplot(Exp_12, aes(x=type, y= avg)) + geom_points
 
 


   ggplot(Exp_11,aes(x=type, y= avg))+geom_boxplot(color = "steelblue", size = .1, alpha=1/2) + geom_point()+geom_jitter()+ geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1)
   
   
   
   
   +ggplot(Exp_12, aes(x=type, y=avg))+ geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1)+geom_point()

q<- ggplot(Exp_12, aes(x=type, y=avg))+ geom_errorbar(aes(ymin= ymin, ymax=ymax), width=.1)+geom_point()
q+ ggplot(Exp_11, aes(x=type, y=avg), width = 0.1)+geom_point()
